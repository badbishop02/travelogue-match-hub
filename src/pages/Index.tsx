...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto mobile-padding py-8">
        {/* Search and Filters */}
        <div className="mb-8">
          <h1 className="mobile-heading font-bold mb-6">Discover Adventures</h1>
          <div className="relative max-w-2xl">
            ...
            <Input
              ...
              className="pl-10 mobile-text h-11 sm:h-12"
            />
          </div>
        </div>
